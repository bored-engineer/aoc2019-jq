...
# hasDouble returns if the number has a double in it
def hasDouble:
	# Convert to a string and just use a regexp
	tostring | test("(00|11|22|33|44|55|66|77|88|99)");
...
| select(is6Digit and hasDouble and noDecrease)]
